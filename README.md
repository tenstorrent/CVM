...
The IEEE 1800-2017 SystemVerilog interface headers under `third_party/` and
`deps/vpi_user.h` are the property of the IEEE and are not covered by the Apache
